...
public class ErrorTextAttributeTagProcessor extends AbstractAttributeTagProcessor
{
	
	private static final String NOME_ATRIBUTO = "errortext";
	private static final int PRECEDENCIA = 1000;

	protected ErrorTextAttributeTagProcessor(String dialectPrefix) 
	{
